...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-propcis-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-propcis-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-propcis-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-propcis-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-propcis-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-propcis-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-propcis` can be installed with:

```
conda install r-propcis
```

It is possible to list all of the versions of `r-propcis` available on your platform with:
